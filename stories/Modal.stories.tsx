      ...
      <DialogContent>
        ...
        <div className="py-4">
          <p className="text-sm text-muted-foreground">
            Modal content goes here. This could be a form, information, or any
            other content.
          </p>
        </div>
        <DialogFooter>
      ...
      <Dialog>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Give your prompt a name so you can easily find it later.
            </DialogDescription>
          </DialogHeader>
    ...
    <Dialog>
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Configure your AI platform preferences and account settings.
          </DialogDescription>
        </DialogHeader>
    ...
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[80vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            Complete guide to using the AI Platform API
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4 text-sm">
            <section>
              ...
              <p className="text-muted-foreground mb-4">
                Welcome to the AI Platform API. This guide will help you get
                started with integrating our AI models into your applications.
              </p>
            </section>
  ...
  https://api.aiplatform.com/v1/chat/completions`}
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                We support various AI models including GPT-4, GPT-3.5 Turbo, and
                Claude 3. Each model has different capabilities and pricing.
              </p>
            </section>
          </div>
        </div>
