...
const mockModels: AIModel[] = [
  {
    ...
    name: "GPT-4o",
    description:
      "Most advanced GPT model with multimodal capabilities and enhanced reasoning",
    provider: "OpenAI",
    capabilities: [
      "text-generation",
      "reasoning",
  ...
  },
  {
    ...
    name: "GPT-4 Turbo",
    description:
      "Enhanced GPT-4 with improved instruction following and JSON mode",
    provider: "OpenAI",
    capabilities: [
      "text-generation",
      "reasoning",
  ...
  },
  {
    ...
    name: "GPT-3.5 Turbo",
    description:
      "Fast and efficient model for most conversational and text tasks",
    provider: "OpenAI",
  ...
  },
  {
    ...
    name: "Claude 3 Opus",
    description:
      "Anthropic's most powerful model for complex analysis and creative tasks",
    provider: "Anthropic",
    capabilities: [
      "text-generation",
      "analysis",
